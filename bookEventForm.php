                ...
                <form action="bookEvent.php" method="POST">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            name="Name" value="<?php echoValue($formdata, "Name")?>" /><!--input-->
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            name="Email" value="<?php echoValue($formdata, "Email")?>" /><!--input-->
                        </div>
                        <div class="col-md-offset-3" style="padding-left:15px">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" id="ContactNum"
                            name="ContactNum" value="<?php echoValue($formdata, "ContactNum")?>" /><!--input-->
                        </div>
                        <div class="col-md-offset-3" style="padding-left:15px">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            name="Title" value="<?php echoValue($formdata, "Title")?>" /><!--input-->
                        </div>
                        <div class="col-md-offset-3" style="padding-left:15px">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            name="Description" value="<?php echoValue($formdata, "Description")?>" /><!--input-->
                        </div>
                        <div class="col-md-offset-3" style="padding-left:15px">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php echoChecked($formdata, "EventType", 1); ?>>  Wedding <br>
                            <input type="radio"  name="EventType" value=2
                            <?php echoChecked($formdata, "EventType", 2); ?>>  Birthday <br>
                            <input type="radio" name="EventType" value=3
                            <?php echoChecked($formdata, "EventType", 3); ?>>  Fashion <br>
                            <input type="radio"  name="EventType" value=4
                            <?php echoChecked($formdata, "EventType", 4); ?>>  Meeting <br>
                        </div>
                        <div class="col-md-offset-3" style="padding-left:15px">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            name="StartDate" value="<?php echoValue($formdata, "StartDate")?>" /><!--input-->
                        </div>
                        <div class="col-md-offset-3" style="padding-left:15px">
