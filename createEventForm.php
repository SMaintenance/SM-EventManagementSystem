...
<body>
    ...
    <div class="content">
        <div class="container">
            <h1 align="center">Create Event Form</h1>
            <!--form title-->
            <br>
            <?php
            ...
            <form action="createEvent.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div style="margin-left: 25%;">
                    ...
                    <div class="form-group">
                        ...
                        <!--event type-->
                        <div class="col-md-5">
                            <input type="radio" name="eType" value=1 <?php echoChecked($formdata, "eType", 1); ?>> Wedding <br>
                            <input type="radio" name="eType" value=2 <?php echoChecked($formdata, "eType", 2); ?>> Birthday <br>
                            <input type="radio" name="eType" value=3 <?php echoChecked($formdata, "eType", 3); ?>> Fashion <br>
                            <input type="radio" name="eType" value=4 <?php echoChecked($formdata, "eType", 4); ?>> Meeting <br>
                        </div>
                        <div class="col-md-4">
